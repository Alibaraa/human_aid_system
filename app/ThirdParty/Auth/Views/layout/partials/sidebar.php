    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4 " data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav ">
                ...
                <li class="menu-item menu-item-open menu-item-here" aria-haspopup="true">
                    <a href="<?php echo site_url('Resolution/add'); ?>" class="menu-link ">
                        <i class="menu-icon flaticon-graphic">
                        </i><span class="menu-text">إضافة قرارات او تعليمات</span></a>
                </li>
                <li class="menu-item menu-item-open menu-item-here" aria-haspopup="true">
                    <a href="<?php echo site_url('Resolution/list'); ?>" class="menu-link ">
                        <i class="menu-icon flaticon-graphic">
                        </i><span class="menu-text">عرض القرارات والتعليمات</span></a>
                </li>
                <li class="menu-item menu-item-open menu-item-here" aria-haspopup="true">
                    <a href="<?php echo site_url('Resolution/search'); ?>" class="menu-link ">
                        <i class="menu-icon flaticon-graphic">
                        </i><span class="menu-text">البحث والإستعلام</span></a>
                </li>
                <li class="menu-item menu-item-open menu-item-here" aria-haspopup="true">
                    <a href="<?php echo site_url('Request/add'); ?>" class="menu-link ">
                        <i class="menu-icon flaticon-graphic">
                        </i><span class="menu-text"> إضافة رسالة</span></a>
                </li>
                <li class="menu-item menu-item-open menu-item-here" aria-haspopup="true">
                    <a href="<?php echo site_url('Request/list'); ?>" class="menu-link ">
                        <i class="menu-icon flaticon-graphic">
                        </i><span class="menu-text"> عرض الرسائل</span></a>
                </li>
                <li class="menu-item menu-item-open menu-item-here" aria-haspopup="true">
                    <a href="<?php echo site_url('/'); ?>" class="menu-link ">
                        <i class="menu-icon flaticon-graphic">
                        </i><span class="menu-text">التقارير (قريبا)</span></a>
                </li>
                <? // RenderMenu(); ?>
