...
class AccountController extends Controller
{
	...
	public function changePassword()
	{
		...
		if (! $this->validate($rules)) {
			return redirect()->to('?error=كلمة المرور الجديدة غير متطابقة')->withInput()
		...
		if (
			...
			return redirect()->to('?error=كلمة المرور السابقة خطأ')->withInput()->with('error', lang('Auth.wrongCredentials'));
		}
		...
		return redirect()->to('?success=تم تعديل كلمة المرور بنجاح')->with('success', lang('Auth.passwordUpdateSuccess'));
	}
