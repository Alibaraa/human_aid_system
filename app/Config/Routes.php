...
$routes->group('person', ['filter' => 'UserActionSaved'], function ($routes) {
    ...
    $routes->get('check', 'Person::chieckIds');
    $routes->post('data/check', 'Person::data_chieckIds');
});
$routes->group('export', ['filter' => 'UserActionSaved'], function ($routes) {
    ...
    $routes->get('filter/daly/report', 'exportControler::daly_report');
    $routes->post('filter/daly/report', 'exportControler::daly_report');

});



$routes->group('constants', ['filter' => 'UserActionSaved'], function ($routes) {
    $routes->get('show/Aids', 'constantsControler::showAids');
    $routes->get('edit/Aids/(:num)', 'constantsControler::editAids/$1');
    $routes->get('edit/Aids/(:num)/(:num)', 'constantsControler::editAids/$1/$2');
    $routes->post('update/Aids/(:num)', 'constantsControler::updateAids/$1');
    $routes->get('add/Aids', 'constantsControler::addAids');
    $routes->get('add/Aids/(:num)', 'constantsControler::addAids/$1');
    $routes->post('insert/Aids', 'constantsControler::insertAids');

    $routes->get('show/Donation', 'constantsControler::showDonation');
    $routes->get('edit/Donation/(:num)', 'constantsControler::editDonation/$1');
    $routes->get('edit/Donation/(:num)/(:num)', 'constantsControler::editDonation/$1/$2');
    $routes->post('update/Donation/(:num)', 'constantsControler::updateDonation/$1');
    $routes->get('add/Donation', 'constantsControler::addDonation');
    $routes->get('add/Donation/(:num)', 'constantsControler::addDonation/$1');
    $routes->post('insert/Donation', 'constantsControler::insertDonation');
...
$routes->group('AreaManager', ['filter' => 'UserActionSaved'], function ($routes) {
    $routes->get('show', 'AreaManagerControler::show');
    $routes->get('ExportData/(:num)', 'AreaManagerControler::ExportData/$1');
    $routes->get('showPerson/(:num)', 'AreaManagerControler::showPerson/$1');

    $routes->get('add', 'AreaManagerControler::add');
    $routes->post('insert', 'AreaManagerControler::insert');

    $routes->get('edit/(:num)', 'AreaManagerControler::edit/$1');
    $routes->post('update/(:num)', 'AreaManagerControler::update/$1');
...
$routes->group('AdisManage', ['filter' => 'UserActionSaved'], function ($routes) {
    ...
    $routes->post('get/person/aids/data/(:num)', 'AdisManageControler::get_person_table_data/$1');
...
$routes->group('API', [], function ($routes) {
    $routes->get('home', 'ApiControler::index');
    $routes->post('update/person/(:num)', 'ApiControler::update/$1');
    $routes->post('create/person', 'ApiControler::create');
    $routes->post('get/person', 'ApiControler::get_persone');
    $routes->get('constant', 'ApiControler::constant_var');
    $routes->get('get/blocks', 'ApiControler::get_blocks');
    $routes->get('get/aid/manage/by/id/(:num)', 'ApiControler::get_aid_manage_by_id/$1');
    $routes->post('get/aid/manage', 'ApiControler::get_aid_manage');
    $routes->post('set/aid/manage/receive', 'ApiControler::set_aid_manage_receive');

    $routes->post('login/user', 'ApiControler::Login');
    $routes->get('logout', 'ApiControler::logout');
