...
<?php endif; ?>
    <div class="card card-custom gutter-b">
        ...
        <form id="add_edit" action="<?php echo base_url('constants/insert/Donation');?>" enctype="multipart/form-data" method="POST">
            <div class="card-body">
                ...
                <div class="form-group row  cct-1">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input required class="form-control" type="text" placeholder="ادخل عنوان " value="<?php // echo set_value('r_title', (isset($editData["r_title"])) ? $editData["r_title"] : ""); ?>" id="title" name="title">
                    </div>
                </div>
