        ...
        <div class="card card-custom">
            ...
            <div class="card-header position-relative align-items-center py-3">
                <div class="card-title align-items-start flex-column">
                    <h3 class="card-label font-weight-bolder text-dark">  إدارة انواع المساعدات </h3>
                </div>
                <!-- زر الفلتر -->
                <a href="<?php echo base_url('constants/add/Aids');?>" class="btn btn-info" >
                <span>
            ...
            <div class="card-body">
                ...
                <table class="table table-separate table-head-custom table-checkable table-striped" id="reports_and_statistics_dt">
                    ...
                    <tbody>
                    <?php $i=0; foreach ($aids as $per) { $i++; ?>
                        <tr>
                            <td style="width: 50px;"><?php echo $i;?></td>
                            <td> <?php echo $per['name'];?> </td>
                            <td> <?php echo $per['note'];?> </td>
                            <td>
                                <a href="<?= base_url(); ?>/constants/edit/Aids/<?php echo $per['id'];?>" class="btn btn-secondary">
