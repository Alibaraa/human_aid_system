    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">
                    إضافة نوع مساعدة جديدة
                </h3>
            </div>
        </div>

        <form id="add_edit" action="<?php echo base_url('constants/insert/Aids');?>" enctype="multipart/form-data" method="POST">
            <div class="card-body">
                ...
                <div class="form-group row  cct-1">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input required class="form-control" type="text" placeholder="ادخل عنوان " value="" id="title" name="title">
                    </div>
                </div>
