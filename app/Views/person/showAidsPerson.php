        ...
        <div class="card card-custom">
            ...
            <div class="card-header position-relative align-items-center py-3">
                <div class="card-title align-items-start flex-column">
                    <h3 class="card-label font-weight-bolder text-dark"> بيانات الاستفادة لـ <?php echo $person['fname'].' '.$person['sname'].' '.$person['tname'].' '.$person['lname'];?>
                    | رقم الهوية <?php echo $person['pid']?>
                        رقم الجوال | <?php echo $person['mob_1']?>
                    </h3>
                </div>
            ...
            <div class="card-body">
                ...
                <table class="table table-separate table-head-custom table-checkable table-striped" id="reports_and_statistics_dt">
                    ...
                    <tbody>
                    <?php $i=0; foreach ($AdisSow as $per) { $i++; ?>
                        <tr>
                            <td style="width: 50px;"><?php echo $i;?></td>
                            <td> <?php echo $per['title'];?> </td>
                            <td> <?php echo $per['name'];?> </td>
                            <td> <?php echo $per['dname'];?> </td>
                            <td> <?php echo $per['quantity'];?> </td>
                            <td> <?php echo $per['insert_date'];?> </td>
