...
<?= $this->section('content') ?>
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            ...
            <a href="<?php echo base_url("uploads/persons_block.xlsx") ?>" style="height: fit-content;margin-top: 15px;" class="btn btn-info" >
                <span>
        ...
        <?php if(!isset($status)){?>
        <form id="add_edit" action="<?php echo base_url('person/upload/csv/block');?>" enctype="multipart/form-data" method="POST">
            <div class="card-body">
