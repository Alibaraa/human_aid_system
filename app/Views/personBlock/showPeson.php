        ...
        <div class="card card-custom">
            ...
            <div class="card-header position-relative align-items-center py-3">
                <div class="card-title align-items-start flex-column">
                    <h3 class="card-label font-weight-bolder text-dark">  إدارة الاسر في مربع /
                ...
                <a href="<?= base_url(); ?>/block/ExportData/<?php echo $block['id'];?>" target="_blank" class="btn btn-secondary">
                    ...
                    <?php $i=0; foreach ($person as $per) { $i++; ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url(); ?>/person/editPerson/<?php echo $per['p_id'];?>" class="btn btn-secondary">
                                    <i class="fas fa-first-aid"></i>
                                    تعديل
                                </a>
                            </td>
