...
<?php endif; ?>
    <div class="card card-custom gutter-b">
        <div class="card-header">
            ...
            <form id="add_edit" action="<?php echo base_url('AdisManage/add');?>" enctype="multipart/form-data" method="POST">
                <div class="card-body">
                    ...
                    <div class="form-group row  cct-1">
                        ...
                        <div class="col-lg-6 col-md-9 col-sm-12">
                            <input class="form-control" type="text" placeholder="ادخل عنوان الكوبون" value="<?php // echo set_value('r_title', (isset($editData["r_title"])) ? $editData["r_title"] : ""); ?>" id="title" name="title">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 col-md-9 col-sm-12">
                            <div class="input-group date">
                                <input type="text" class="form-control datepicker-custom-rtl" value="<?php // echo set_value('DateOfCreation', (isset($editData["DateOfCreation"])) ? $editData["DateOfCreation"] : ""); ?>" id="Date" name="Date"  placeholder="اختيار تاريخ">
