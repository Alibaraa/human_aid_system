...
<?php endif; ?>
    <div class="card card-custom gutter-b">
        ...
        <form id="add_edit111" action="<?php echo base_url('User/insert/data');?>" enctype="multipart/form-data" method="POST">
            <div class="card-body">
                ...
                <div class="form-group row  cct-1">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input class="form-control" type="text" placeholder="اسم المستخدم" value="" id="name" name="name">
                    </div>
                </div>
                ...
                <div class="form-group row  cct-1">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input class="form-control" type="email" placeholder="البريد الإلكتروني" value="" id="email" name="email">
                    </div>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6 col-md-9 col-sm-12">
                    <select class="form-control selectpicker" id="permissions" name="permissions" title="صلاحية المسخدم" data-size="7" data-live-search="true">
                        ...
                        <option value="3" > مندوب منطقة</option>
                    </select>
                </div>
            </div>
